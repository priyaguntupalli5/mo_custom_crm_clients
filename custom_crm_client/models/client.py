...
class Client(models.Model):
    ...
    family_id = fields.Many2one('crm.family',
    ...
    ], string='Client Location', help="information.")
    ...
    immigration_category = fields.Char(string='Immigration Category')
    eligible_to_work = fields.Boolean(string='Eligible to Work in Canada')
    ...
    referred_by_selection = fields.Selection([
        ...
        ('Non-governmental newspaper/media/publication/brochure/Website',
         'Non-governmental newspaper/media/publication/brochure/Website'),
    ...
    business_opening_interest = fields.Selection([("yes", "Yes"), ("no", "No")],
                                                 string="Interested in opening own business")
